...
#include "config.h"
extern System::Dirver::Soft_IIC i2c_Dev;
...
#define i2c_write       i2c_Dev.Soft_IIC_Write_Len//MPU_Write_Len
#define i2c_read        i2c_Dev.Soft_IIC_Read_Len//MPU_Read_Len
#define MPU_IIC_Init    i2c_Dev.Soft_IIC_Init

#define delay_ms    i2c_Dev.delay_ms//MPU_Delay_ms
