...
extern Dirver::Soft_IIC i2c_Dev;
#define On_Chip_IIC
#define __SOFTI2C_
...
#define OLED_ADDRESS        0x78
#define OLED_WriteCommand(Command)  i2c_Dev.Soft_IIC_Write_Byte(OLED_ADDRESS,OLED_Command_Mode,Command)//Soft_IIC_WriteByte(OLED_ADDRESS,OLED_Command_Mode,Command)
#define OLED_WriteData(Data,Count)  i2c_Dev.Soft_IIC_Write_Len(OLED_ADDRESS,OLED_Data_Mode,Count,Data)//Soft_IIC_WriteData(OLED_ADDRESS,OLED_Data_Mode,Data,Count)
#define OLED_GPIO_Init()            i2c_Dev.Soft_IIC_Init()//Soft_IIC_Init()
